        ...
        <div className="w-11/12 max-w-md md:bg-white bg-transparent p-4 md:p-8 md:rounded-lg rounded-none md:shadow-md shadow-none text-center">
          <div className="mb-6">
            <Image
              ...
              width={150}
            />
            <h1 className="text-2xl font-tsel-batik font-bold text-black">
              Verifikasi
            </h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              <label
                className="block text-left font-poppins text-gray-600"
                htmlFor="role"
              >
                Role
              </label>
            ...
            <div className="flex items-start mt-4">
              ...
              />
              <label
                className="text-sm font-poppins text-gray-500 text-left"
                data-testid="tnc"
                htmlFor="terms"
              >
                Dengan menggunakan aplikasi ini Anda telah setuju untuk
                membagikan lokasi Anda kepada para tukang Bakso Keliling.
              </label>
            </div>
            {errors.terms && (
              <p className="text-red-500 text-sm mt-1 text-left">
